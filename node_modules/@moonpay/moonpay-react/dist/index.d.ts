...
interface RampsChildToParentInterface extends RampsSwapsKycChildToParentInterface, RampsConsumerKycChildToParentInterface, RampsMoonPayBalanceChildToParentInterface {
    ...
    /**
     * Fired when the customer successfully completes an account challenge.
     */
    onChallengeCompleted(): Promise<void>;
    /**
...
interface AccountChallengeWidgetQueryParams extends ThemeQueryParams {
    /**
     * The id of the account challenge to be displayed in the widget.
     */
    challengeId?: string;
}
...
type MoonPayWebSdkConfig$1 = MoonPayCoreSdkConfigWithoutHandlers & {
    /**
...
type MoonPayWebSdkExtendedConfig = WithLogger<MoonPayWebSdkConfig$1> & {
    sdkEnvironment: MoonPayWebSdkEnvironment;
};

declare class MoonPayWebSdk extends MoonPayCoreSdk {
    private variant;
    ...
    constructor({ useOverlay, variant, containerNodeSelector, useWarnBeforeRefresh, ...coreConfig }: MoonPayWebSdkConfig$1);
    /**
     * Closes widget and clears subscribed events.
     */
    close(): void;
...
type MoonPayWebSdkInitFn = (config: MoonPayWebSdkConfig$1) => MoonPayWebSdk | null;

declare function loadMoonPay(version?: string | null): Promise<MoonPayWebSdkInitFn | undefined>;

type MoonPayInitFn = NonNullable<Awaited<ReturnType<typeof loadMoonPay>>>;
type MoonPayWebSdkConfig = Parameters<MoonPayInitFn>[0];
type TFlow = MoonPayWebSdkConfig['flow'];
type ExtractFlow<T, F extends TFlow> = T extends {
    flow: F;
} ? T : never;
type ExtractedConfig<T extends TFlow> = ExtractFlow<MoonPayWebSdkConfig, T>;
type ExtractedConfigParams<T extends TFlow> = ExtractedConfig<T>['params'];
type ExtractedConfigParamsWithoutApiKey<T extends TFlow> = Omit<ExtractedConfigParams<T>, 'apiKey'>;
type ExtractedConfigForProps<T extends TFlow> = Omit<ExtractedConfig<T>, 'flow' | 'params' | 'environment' | 'handlers' | 'auth' | 'debug'>;
type ExtractedConfigHandlers<T extends TFlow> = ExtractedConfig<T>['handlers'];
type ExtractedConfigAuth<T extends TFlow> = ExtractedConfig<T>['auth'];
type OnUrlSignatureRequested = (url: string) => Promise<string> | void;
type StylingProps = {
    style?: React.CSSProperties;
    className?: string;
};
type MoonPayWidgetProps<T extends TFlow> = ExtractedConfigHandlers<T> & {
    auth?: ExtractedConfigAuth<T>;
} & ExtractedConfigParamsWithoutApiKey<T> & ExtractedConfigForProps<T> & StylingProps & {
    visible?: boolean;
    onUrlSignatureRequested?: 'signature' extends keyof ExtractedConfigParams<T> ? OnUrlSignatureRequested : undefined;
};
type MoonPayAccountChallengeProps = MoonPayWidgetProps<'accountChallenge'>;
type MoonPayBuyProps = MoonPayWidgetProps<'buy'>;
type MoonPaySellProps = MoonPayWidgetProps<'sell'>;
type MoonPayBalanceWithdrawProps = MoonPayWidgetProps<'moonPayBalanceWithdraw'>;
type MoonPayBalanceDepositProps = MoonPayWidgetProps<'moonPayBalanceDeposit'>;
type MoonPaySwapsCustomerSetupProps = MoonPayWidgetProps<'swapsCustomerSetup'>;
type MoonPayConsumerKycProps = MoonPayWidgetProps<'consumerKyc'>;
type MoonPayNftProps = MoonPayWidgetProps<'nft'>;
type MoonPayClaimProps = MoonPayWidgetProps<'claim'>;
type MoonPayTopUpBalanceLedgerProps = MoonPayWidgetProps<'topup'>;
type MoonPayWithdrawLedgerProps = MoonPayWidgetProps<'withdraw'>;
type MoonPaySwapProps = MoonPayWidgetProps<'swap'>;
type MoonPayTransactionTrackerProps = MoonPayWidgetProps<'transactionTracker'>;
type MoonPayPartnerTopupProps = MoonPayWidgetProps<'partnerTopup'>;

declare function MoonPayBalanceDepositWidget(props: MoonPayBalanceDepositProps): react_jsx_runtime.JSX.Element;

declare function MoonPayBalanceWithdrawWidget(props: MoonPayBalanceWithdrawProps): react_jsx_runtime.JSX.Element;

declare function MoonPayBuyWidget(props: MoonPayBuyProps): react_jsx_runtime.JSX.Element;

/**
 * @deprecated
 */
declare function MoonPayConsumerKycWidget(props: MoonPayConsumerKycProps): react_jsx_runtime.JSX.Element;

declare function MoonPayNftCheckoutWidget(props: MoonPayNftProps): react_jsx_runtime.JSX.Element;

declare function MoonPayNftClaimWidget(props: MoonPayClaimProps): react_jsx_runtime.JSX.Element;
...
declare const MoonPayContext: react.Context<MoonPayContext>;
declare const MoonPayProvider: ({ children, apiKey, debug, }: MoonPayProviderProps) => react_jsx_runtime.JSX.Element;

declare function MoonPaySellWidget(props: MoonPaySellProps): react_jsx_runtime.JSX.Element;

declare function MoonPaySwapsCustomerSetupWidget(props: MoonPaySwapsCustomerSetupProps): react_jsx_runtime.JSX.Element;

declare function MoonPaySwapWidget(props: MoonPaySwapProps): react_jsx_runtime.JSX.Element;

declare function MoonPayTopUpLedgerWidget(props: MoonPayTopUpBalanceLedgerProps): react_jsx_runtime.JSX.Element;

declare function MoonPayTopUpWidget(props: MoonPayPartnerTopupProps): react_jsx_runtime.JSX.Element;

declare function MoonPayTransactionTrackerWidget(props: MoonPayTransactionTrackerProps): react_jsx_runtime.JSX.Element;

declare function MoonPayWithdrawLedgerWidget(props: MoonPayWithdrawLedgerProps): react_jsx_runtime.JSX.Element;

declare function MoonpayAccountChallengeWidget(props: MoonPayAccountChallengeProps): react_jsx_runtime.JSX.Element;

export { MoonPayBalanceDepositWidget, MoonPayBalanceWithdrawWidget, MoonPayBuyWidget, MoonPayConsumerKycWidget, MoonPayContext, MoonPayNftCheckoutWidget, MoonPayNftClaimWidget, MoonPayProvider, MoonPaySellWidget, MoonPaySwapWidget, MoonPaySwapsCustomerSetupWidget, MoonPayTopUpLedgerWidget, MoonPayTopUpWidget, MoonPayTransactionTrackerWidget, MoonPayWithdrawLedgerWidget, MoonpayAccountChallengeWidget };
